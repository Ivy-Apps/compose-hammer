...
private fun MutableList<MaterialComponent>.component(
    ...
    implementationTip: String? = null,
    customImplementation: String? = null,
    customImplementationTip: String? = null,
    ...
    add(
        MaterialComponent(
            ...
            defaultImplementationTip = implementationTip,
            customImplementation = customImplementation,
            customImplementationTip = customImplementationTip,
        )
    )
}
// endregion